...
|Dev|Qa|Prod|
|---|-----|---|
|- 코드 작성 <br> - 단위 테스트 <br> - 기능 테스트 <br> - 코드, API 문서화 <br> - CI (commit 시 build, test, static code analysis, push 자동화)|- 기능 테스트 <br> - 성능 부하 테스트 <br> - 보안 테스트 <br> - 로깅 및 모니터링 <br> - 배포 준비|- CD (main 브랜치로 merge 완료 시, CI서버가 build, test 후 배포 자동화) <br> - 성능 모니터링 <br> - 로깅 및 모니터링 <br> - 업데이트 및 유지보수|
